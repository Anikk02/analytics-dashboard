...
### Pipeline Steps:
1. `generate_data.py` → Creates raw CSV files  
2. `clean_data.py` → Cleans missing values, normalizes formats  
3. `analyze.py` → Aggregates metrics, generates analytics datasets  
